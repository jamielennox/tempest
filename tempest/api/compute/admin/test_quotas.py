...
class QuotasAdminTestJSON(base.BaseV2ComputeAdminTest):
    ...
    def test_get_updated_quotas(self):
        ...
        project_name = data_utils.rand_name('cpu_quota_tenant')
        ...
        quota_set = self.adm_client.show_quota_set(project_id)
    ...
    def test_delete_quota(self):
        ...
        project_name = data_utils.rand_name('ram_quota_tenant')
        project_desc = project_name + '-desc'
        project = self.identity_utils.create_project(name=project_name,
                                                     description=project_desc)
        project_id = project['id']
        ...
        quota_set_new = self.adm_client.show_quota_set(project_id)
